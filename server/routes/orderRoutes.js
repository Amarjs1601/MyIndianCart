...
//  GET ALL ORDERS
router.get("/my-orders", isAuth,isAdmin, getMyOrdersCotroller);

//  GET SINGLE ORDER DETAILS
router.get("/my-orders/:id", isAuth,isAdmin, singleOrderDetrailsController);

// acceipt payments
router.post("/payments", isAuth,isAdmin, paymetsController);
